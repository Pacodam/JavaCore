package tutorialPointDP.structural.compositepattern;
 ...
 *
 * Implementation
 * We have a class Employee which acts as composite pattern actor class. CompositePatternDemo, our demo class
 * will use Employee class to add department level hierarchy and print all employees.
 */
