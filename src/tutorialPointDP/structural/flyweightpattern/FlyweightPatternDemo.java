 ...
 * new object when no matching object is found. We will demonstrate this pattern by drawing 20 circles
 * of different locations but we will create only 5 objects. Only 5 colors are available so color property
 ...
 * It will pass information (red / green / blue/ black / white) to ShapeFactory to get
 * the circle of desired color it needs.
 */
